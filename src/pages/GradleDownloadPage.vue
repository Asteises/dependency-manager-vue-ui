<template>
  <div class="upload-container">
    <h2 class="upload-title">Загрузите файл build.gradle</h2>
    ...
    >
      ...
      <div class="dropzone-content">
        <img src="@/assets/images/gradle-upload.svg" alt="Upload Gradle Dependency" class="dropzone-icon" />
        <p class="dropzone-text">Перетащите файл build.gradle сюда</p>
