<template>
  <div class="upload-container">
    <h2 class="upload-title">Загрузите файл pom.xml</h2>
    ...
    >
      ...
      <div class="dropzone-content">
        <img src="@/assets/images/maven-upload.svg" alt="Upload Dependency" class="dropzone-icon" />
        <p class="dropzone-text">Перетащите файл pom.xml сюда</p>
